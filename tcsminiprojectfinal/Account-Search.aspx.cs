...
namespace UI
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (s1 && s2)
            {
                Response.Write("<script type=\"text/javascript\">alert('Fill Either One');window.location.href='Account-Search.aspx'; </script>");
            ...
            else if (s1)
            {
                ...
                if (accounts.Count == 0)
                {
                    ...
                    Response.Redirect("<script>alert('Account Id doesnot exsist');window.location.href='Account-Search.aspx';</script>");
            ...
            else if (s2)
            {
                ...
                if (daccounts.Count == 0)
                {
                    ...
                    Response.Write("<script type=\"text/javascript\">alert('Customer Doesnot Exists');window.location.href='Account-Search.aspx'; </script>");
        ...
        protected void TextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (accounts.Count == 0)
            {
                Response.Write("<script type=\"text/javascript\">alert('Account Doesnot Exists');window.location.href='Account-Search.aspx'; </script>");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            else if (s2)
            {
                ...
                if (daccounts.Count == 0)
                {
                    ...
                    Response.Write("<script type=\"text/javascript\">alert('Customer Id Doesnot Exists');window.location.href='Account-Search.aspx'; </script>");
