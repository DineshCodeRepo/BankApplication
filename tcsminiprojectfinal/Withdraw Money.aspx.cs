...
namespace UI
{
    public partial class WebForm12 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Amount <= 0)
            {
                Response.Write("<script type=\"text/javascript\">alert('Enter Proper Amount');window.location.href='Withdraw Money.aspx';</script>");
            ...
            else
            {
                ...
                if (transid == 0)
                {
                    Response.Write("<script type=\"text/javascript\">alert('Transaction UnSuccessfull');window.location.href='Withdraw Money.aspx';</script>");

                }
                else
                {
                    Response.Write("<script type=\"text/javascript\">alert('Transaction Successfull');window.location.href='Withdraw Money.aspx';</script>");
